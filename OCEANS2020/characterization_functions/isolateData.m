...
function [trial1, trial2] = isolateData(ttank,ttankftype,mbed,mbedftype,t11,t12,t21,t22,speed)

%temp development region start***********
mbedOffset = 1.2 %Startup time for mbed
%Constants: Average Values of drag w/ props open

switch speed
    case 1
        Fd = 3.7%abs(3.7 - 3.88) %The difference between the avg propeller drag and the hangingsystem static is read as true drag
    case 2
        Fd = 3.36%abs(3.36 - 3.88)
    case 3
        Fd = 3.085%abs(3.085 - 3.88)
    case 4
        Fd = 2.845%abs(2.845 - 3.88)
end
